...
- **Guest**: Views shared archives, requires Guest Access Pass (180-day JWT).

## Sprint 3: Polish & Recording [🟢 DEPLOYED - 🛠️ BUGFIXING]
- [x] **HOTFIX-04**: Build Error: Fix malformed JSON parsing for SERVICE_ACCOUNT_JSON.
- [x] **HOTFIX-05**: Runtime Error: `getIdToken` is not a function on Prompts page.
