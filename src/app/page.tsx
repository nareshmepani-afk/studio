...
import { Sparkles, Film, Users, Lock, BookOpenText, ArrowRight } from 'lucide-react'; // Changed BookOpen to BookOpenText
      ...
      <main className="flex-grow">
        ...
        <section className="py-20 md:py-32 text-center bg-transparent">
          <div className="container mx-auto px-4">
            <BookOpenText className="mx-auto h-20 w-20 text-primary mb-6 animate-bounce" /> {/* Changed Icon */}
