...
import { X, CalendarDays, MapPin, Heart, Share2, Download, Maximize2, Layers, Play, Pause, Volume2, VolumeX, Bookmark, Music, Sparkles, Eye, Smile, FileText, Cast, Airplay, Tv, Copy, MessageSquare, Mail } from 'lucide-react';
  ...
  const content = (
    <AnimatePresence>
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="fixed inset-0 z-[9999] flex items-center justify-center bg-slate-950/95 backdrop-blur-2xl p-4 md:p-8"
      >
        ...
        {isShareModalOpen && (
          <div className="fixed inset-0 z-[10000] bg-slate-950/90 backdrop-blur-2xl flex items-center justify-center p-4 select-none animate-fade-in">
            <motion.div 
