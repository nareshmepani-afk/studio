              ...
              <button 
                onClick={() => {
                  ...
                  toast.success("Editor Unlocked", {
                    description: "Production lock released. Returning to editor for manual control."
                  });
                }}
                className="px-3 py-1.5 bg-amber-500/20 border border-amber-500/40 rounded-lg text-[9px] font-black text-amber-400 uppercase tracking-widest hover:bg-amber-500/30 transition-all flex items-center gap-2 cursor-pointer"
              >
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-8 space-y-12">
          ...
          {preFlightBrief && (
            <div className="space-y-12">
              {/* Sensory Anchors */}
              {Array.isArray(preFlightBrief.sensoryAnchors) && preFlightBrief.sensoryAnchors.length > 0 && (
              ...
              {/* Vocal Instructions */}
              {Array.isArray(preFlightBrief.vocalInstructions) && preFlightBrief.vocalInstructions.length > 0 && (
                <div className="space-y-6">
                  <div className="flex items-center gap-3">
