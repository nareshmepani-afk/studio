      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <motion.div
            ...
            className={`absolute z-[500] w-7 h-7 bg-emerald-500 text-slate-950 rounded-full flex items-center justify-center font-black text-[11px] shadow-[0_0_20px_rgba(16,185,129,0.8)] border border-white/40 cursor-help ${className}`}
          >
            {number}
            <motion.div 
