...
- **2026-08-25**: v1.1.0-beta-MW-198. Enabled Bilingual Hybrid prompt and chapter subtitle rendering across StudioDashboard.tsx, useStudioData.ts, and PromptCard.tsx; enriched Studio and Navbar with extensive data-hotspot-id attributes and enhanced HotspotOverlay with active hotspot count badge and jsdom/URL listeners (237 Vitest tests green). (Build Verify: SUCCESS, User Sign-Off: VERIFIED)
